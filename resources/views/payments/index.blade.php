			...
			<div class="col-md-12">
				...
				<div class="col-md-8">
					...
					<div class="C.O.D.">
						...
						<p>
							При отриманні Ви називаєте номер декларації (повдомляється Вам одразу після відправки) і надаєте документ, що засвідчує особу.
						</p>
					</div>
				</div>
			</div>
