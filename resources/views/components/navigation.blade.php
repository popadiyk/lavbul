...
{{--     <div class="hidden-xs hidden-sm navigation">
    ...
    <nav class="navigation">
        <div class="navbar-header">
          ...
          <a class="navbar-brand hidden-sm hidden-md hidden-lg" style="text-transform: uppercase; font-weight: bolder;" href="#">Лавка-Булавка</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse" aria-expanded="false" style="height: 1px; background-color: rgba(107,107,107,0.88); ">
...
{{--    <li role="separator" class="divider"></li>
  ...
  <li><a href="#">One more separated link</a></li>  --}}
            ...
            <li class="cart-nav"><a href="#basket_modal" data-toggle="modal"><i class="fa fa-cart-arrow-down fa-2x" aria-hidden="true"></i><span class="cart_counter">{{ Cart::count() }}</span></a></li>
            <li class="user user-nav" style="position: relative;" >
            @if (Auth::user())
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    <i class="fa fa-user-circle-o fa-2x" aria-hidden="true" title="{{ Auth::user()->name }}"></i>
                </a>
            ...
            @else
                ...
                <ul class="col-md-12 dropdown-menu keep-open-on-click" style="position: absolute;">
                    <ul class="nav nav-tabs">
