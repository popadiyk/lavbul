...
@section('page_header')
    <h1 class="page-title">
        <i class="voyager-list"></i>Клієнти
        @if (Voyager::can('add_'.$dataType->name))
            <a href="{{ route('voyager.'.$dataType->slug.'.create') }}" class="btn btn-success">
                <i class="voyager-plus"></i> Створити нового клієнта
            </a>
        @endif    </h1>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="voyager-trash"></i> Ви впевнені, що бажаєте видалити
                        цього {{ $dataType->display_name_singular }}?</h4>
                </div>
